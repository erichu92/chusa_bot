...
This node subscribe map and publish goal to navigation node.

/motor_controller

This node convert velocity to pulse for stepper motor.
...
This node subscribe cmd_vel and operate stepper motor. And publish wheel twist for making odometry.

/arduino/tilt_lidar

This node get the service from explore node and operate tilt stepper motor.


-----------------------------------------------------------------------------------

How to launch chusa_bot

1. Roscore

2. Roslaunch chusa_bot.launch at Raspberry Pi

3. Roslaunch chusa_2d.launch for 2d mapping.
   Roslaunch chusa_3d.launch for 3d mapping.
