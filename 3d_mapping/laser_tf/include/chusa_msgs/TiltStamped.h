...
struct MD5Sum< ::chusa_msgs::TiltStamped_<ContainerAllocator> >
{
  ...
  {
    return "4e6ba2e7947c12a4e337236cbd925e55";
  }

  static const char* value(const ::chusa_msgs::TiltStamped_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x4e6ba2e7947c12a4ULL;
  static const uint64_t static_value2 = 0xe337236cbd925e55ULL;
};
